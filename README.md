...
1. 该项目需要分为两个工程打开(建议两个窗口)，分别是support和parent -- Class热更新和Apt都需要以jar包的形式工作，因此需要使用独立编译。
...
游戏行业最多的书籍是什么？是引擎相关的书籍，这些书教你怎么使用Unity或Unreal，却没有一个教你如何实现一套好的技能系统，AI系统的。
即便是有人初版过一些游戏AI或技能设计的书籍，也都是泛泛而谈，或者方案太差劲。  

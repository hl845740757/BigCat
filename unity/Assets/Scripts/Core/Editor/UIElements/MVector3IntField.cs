...
{
public class MVector3IntField : Vector3IntField, IPrefixLabel
{
    private bool _isReadOnly;
    private bool _isDelayed;
    private float _xyzFlexBasis;

    public MVector3IntField() {
    }

    public MVector3IntField(string label) : base(label) {
    }
    ...
    private IntegerField xField => (IntegerField)inputContent[0];
    private IntegerField yField => (IntegerField)inputContent[1];
    private IntegerField zField => (IntegerField)inputContent[2];

    public new class UxmlFactory : UxmlFactory<MVector3IntField, UxmlTraits>
    {
    }

    public new class UxmlTraits : Vector3IntField.UxmlTraits
    {
        ...
        public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc) {
            base.Init(ve, bag, cc);
            var myView = (MVector3IntField)ve;

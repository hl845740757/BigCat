...
public class MVector4Field : Vector4Field, IField
{
    ...
    public MVector4Field() {
    }

    public MVector4Field(string label) : base(label) {
    }
    ...
    public float wLabelMargin {
        get => wField.labelElement.style.marginRight.value.value;
        set => wField.labelElement.style.marginRight = new Length(value);
    }
    ...
    private FloatField wField => (FloatField)inputContent[3];

    public new class UxmlFactory : UxmlFactory<MVector4Field, UxmlTraits>
    {
    }
    ...
    public new class UxmlTraits : Vector4Field.UxmlTraits
    {
        ...
        public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc) {
            ...
            myView.wLabel = wLabel.GetValueFromBag(bag, cc);
            //
            ...
            myView.wLabelMargin = wLabelMargin.GetValueFromBag(bag, cc);

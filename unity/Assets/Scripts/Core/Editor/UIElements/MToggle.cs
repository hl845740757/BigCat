...
{
public class MToggle : Toggle, IPrefixLabel
{
    public MToggle() {
    }

    public MToggle(string label) : base(label) {
    }
    ...
    public new class UxmlFactory : UxmlFactory<MToggle, UxmlTraits>
    {
    }

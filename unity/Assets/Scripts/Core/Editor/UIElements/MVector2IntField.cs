...
{
public class MVector2IntField : Vector2IntField, IPrefixLabel
{
    private bool _isReadOnly;
    private bool _isDelayed;
    private float _xyzFlexBasis;

    public MVector2IntField() {
    }

    public MVector2IntField(string label) : base(label) {
    }
    ...
    public new class UxmlFactory : UxmlFactory<MVector2IntField, UxmlTraits>
    {
    }

    public new class UxmlTraits : Vector2IntField.UxmlTraits
    {
        ...
        public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc) {
            base.Init(ve, bag, cc);
            var myView = (MVector2IntField)ve;

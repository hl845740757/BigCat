...
public class MFloatField : FloatField, IField
{
    ...
    public new class UxmlFactory : UxmlFactory<MFloatField, UxmlTraits>
    {
    }
    ...
    public new class UxmlTraits : TextValueFieldTraits<float, UxmlFloatAttributeDescription>
    {
        ...
        private readonly UxmlFloatAttributeDescription maxAttribute = new()
        {
            name = "max",
            defaultValue = 0,
        };

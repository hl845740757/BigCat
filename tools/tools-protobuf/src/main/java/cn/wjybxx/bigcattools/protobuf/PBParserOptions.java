...
public class PBParserOptions {
    ...
    /** 方法是否启用建造者模式 */
    private boolean methodBuilderPattern = false;
    ...
    public boolean isMethodBuilderPattern() {
        return methodBuilderPattern;
    }

    public PBParserOptions setMethodBuilderPattern(boolean methodBuilderPattern) {
        this.methodBuilderPattern = methodBuilderPattern;
        return this;
    }

...
public class AutoFieldsProcessor extends MyAbstractProcessor {
    ...
    private static final String CNAME_ALIAS = "cn.wjybxx.base.annotation.Alias";
    public static final String CNAME_AUTO = "cn.wjybxx.bigcat.annotation.AutoFields";

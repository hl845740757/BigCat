...
import cn.wjybxx.bigcat.rpc.ExtensibleService;
import cn.wjybxx.bigcat.tools.TestUtil;
import cn.wjybxx.bigcat.tools.protobuf.gen.MethodInfoExporterGenerator;
import cn.wjybxx.bigcat.tools.protobuf.gen.ServiceGenerator;
...
public class PBParserTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        options.setProtoDir(projectDir.getPath() + "/testres/")
                .setTempDir(projectDir.getPath() + "/testres/temp/")
                .setLineSeparator("\n")

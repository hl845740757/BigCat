 ...
 * date 2023/4/1
 */
public class ConstantPoolSnapshot<T extends Constant<T>> {
    ...
    ConstantPoolSnapshot(ConstantPool<T> pool) {
        ...
        this.isContinuous = EnumUtils.isNumberContinuity(immutableValues, Constant::id);

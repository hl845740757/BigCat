...
import cn.wjybxx.common.dson.document.codecs.MapAsObjectCodec;
...
public class ConvertOptions {
     ...
     * 是否把Map编码为普通对象
     * 1.只在文档编解码中生效
     * 2.在Dson中，Map被看做一个特殊的数组结构，而不是普通的Object，它们本就是性质不同的对象。
     * 如果要将一个Map结构编码为普通对象，<b>Key的运行时必须和声明类型相同</b>，且只支持String、Integer、Long、DsonEnum。

...
public class Bits {
    ...
    public static boolean notSet(final long value, final long mask) {
        return (value & mask) != mask;
    }
    ...
    public static boolean notSetAt(int flags, int idx) {
        return notSet(flags, 1 << idx);
    }

    public static boolean notSetAt(long flags, int idx) {
        return notSet(flags, 1L << idx);
    }

 ...
 * date - 2023/6/2
 */
public class DsonLineBufferImpl implements DsonLineBuffer {
    ...
    public DsonLineBufferImpl(List<String> lines) {
        this.lines = precompile(lines);
    }
    ...
    private static class LineInfo {
        ...
        public LineInfo(String line, int startPos, int endPos, int contentStartPos, DsonLheadType lheadType, int index) {
            this.line = line;
    ...
    private static List<LineInfo> precompile(List<String> lines) {
        List<LineInfo> mergedLines = new ArrayList<>(lines.size());
        int lineIndex = -1;
        int startPos = 0;
        int endPos = -2;
        for (final String line : lines) {
            ...
            mergedLines.add(new LineInfo(line, startPos, endPos, contentStartPos, lheadType, lineIndex));
        }
        return mergedLines;
    }
    ...
    public static void main(String[] args) {
        ...
        DsonScanner scanner = new DsonScanner(new DsonLineBufferImpl(x.lines().collect(Collectors.toList())));
        while (true) {

...
public class AutoTypeArgsProcessor extends MyAbstractProcessor {
    ...
    public static final String AUTO_CANONICAL_NAME = "cn.wjybxx.bigcat.common.codec.AutoTypeArgs";
    ...
    private TypeArgMirrors parseMapTypeArgs(VariableElement variableElement, FieldImplProperties properties) {
    ...
    private TypeArgMirrors parseCollectionTypeArgs(VariableElement variableElement, FieldImplProperties properties) {
    ...
    private TypeMirror parseMapVarImpl(VariableElement variableElement, FieldImplProperties properties) {
    ...
    private TypeMirror parseCollectionVarImpl(VariableElement variableElement, FieldImplProperties properties) {
        if (!AptUtils.isBlank(properties.readProxy)) {
            return null; // 有读代理，不需要解析
        }

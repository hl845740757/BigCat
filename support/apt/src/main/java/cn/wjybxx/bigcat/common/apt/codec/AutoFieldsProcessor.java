...
public class AutoFieldsProcessor extends MyAbstractProcessor {
    ...
    public static final String AUTO_CANONICAL_NAME = "cn.wjybxx.bigcat.common.codec.document.AutoFields";
    private static final String ALIAS_CANONICAL_NAME = "cn.wjybxx.bigcat.common.codec.document.FieldAlias";
    ...
    private List<FieldSpec> genConstantFields(TypeElement typeElement) {
        if (typeElement.getKind() == ElementKind.ENUM) {
            ...
            final boolean skipInstance = AptUtils.getAnnotationValueValueWithDefaults(elementUtils, annotationMirror, PROPERTY_SKIP_INSTANCE);

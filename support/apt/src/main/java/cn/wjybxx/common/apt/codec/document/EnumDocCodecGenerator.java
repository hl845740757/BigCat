 ...
 * date 2023/4/13
 */
public class EnumDocCodecGenerator extends AbstractGenerator<DocumentCodecProcessor> {

    public EnumDocCodecGenerator(DocumentCodecProcessor processor, TypeElement typeElement) {
    ...
    public void execute() {
        ...
        final String typeAlias = processor.getTypeAlias(typeElement);

        MethodSpec constructor = MethodSpec.constructorBuilder()
                .addModifiers(Modifier.PUBLIC)
                .addStatement("super($T.class, $T::forNumber, $S)", rawTypeName, rawTypeName, typeAlias)
                .build();

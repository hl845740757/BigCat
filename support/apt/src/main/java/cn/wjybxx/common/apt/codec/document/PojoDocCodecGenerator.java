 ...
 * date 2023/4/13
 */
public class PojoDocCodecGenerator extends CodecGenerator<DocumentCodecProcessor> {

    public PojoDocCodecGenerator(DocumentCodecProcessor processor, TypeElement typeElement) {
    ...
    protected void gen() {
        TypeSpec.Builder typeBuilder = super.genCommons(DocumentCodecProcessor.getCodecClassName(typeElement, elementUtils))
                .addMethod(processor.newGetTypeNameMethod(superDeclaredType, typeElement));

...
public struct GBitSet : IEquatable<GBitSet>
{
    ...
    public bool Equals(GBitSet other) {
        return _lowBits == other._lowBits && _highBits == other._highBits;
    }

    public override bool Equals(object obj) {
        return obj is GBitSet other && Equals(other);
    }

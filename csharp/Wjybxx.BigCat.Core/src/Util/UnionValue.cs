...
public struct UnionValue : IEquatable<UnionValue>
{
    ...
    /// </summary>
    [FieldOffset(0)] public readonly sbyte type;
    /// <summary>
    /// 由于内存对齐的原因，为避免内存浪费，我们在double前面插入三个byte和1个int值
    /// </summary>
    ...
    /// double
    /// </summary>
    [FieldOffset(8)] public double d1;
    [FieldOffset(16)] public double d2;
    [FieldOffset(24)] public double d3;
    /// <summary>
    /// long
    /// </summary>
    ...
    public UnionValue(sbyte type) : this() {

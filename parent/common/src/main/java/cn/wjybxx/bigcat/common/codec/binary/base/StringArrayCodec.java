...
public class StringArrayCodec implements BinaryPojoCodecImpl<String[]> {
    ...
    @Override
    public void writeObject(String[] instance, BinaryWriter writer, TypeArgInfo<?> typeArgInfo) {
    ...
    @Override
    public String[] readObject(BinaryReader reader, TypeArgInfo<?> typeArgInfo) {

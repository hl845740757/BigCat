...
public final class Tuple3<A, B, C> {
    ...
    public Tuple3(BinaryReader reader) {
        A first = reader.readObject();
        B second = reader.readObject();
        C third = reader.readObject();
        this.tuple2 = new Tuple2<>(first, second);
        this.third = third;
    }
    ...
    public void writeObject(BinaryWriter writer) {
        ...
        writer.writeObject(tuple2.getFirst());
        writer.writeObject(tuple2.getSecond());
        writer.writeObject(third);
    }

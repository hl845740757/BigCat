...
public abstract class AbstractDocumentPojoCodecImpl<T> implements DocumentPojoCodecImpl<T> {
     ...
     */
    public abstract void readFields(T instance, DocumentReader reader, TypeArgInfo<?> typeArgInfo);

    /**
     * 用于执行用户序列化完成的钩子方法
     */
    protected void afterDecode(T instance, DocumentReader reader, TypeArgInfo<?> typeArgInfo) {

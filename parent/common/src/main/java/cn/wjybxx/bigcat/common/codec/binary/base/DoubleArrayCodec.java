...
public class DoubleArrayCodec implements BinaryPojoCodecImpl<double[]> {
    ...
    @Override
    public void writeObject(double[] instance, BinaryWriter writer, TypeArgInfo<?> typeArgInfo) {
    ...
    @Override
    public double[] readObject(BinaryReader reader, TypeArgInfo<?> typeArgInfo) {

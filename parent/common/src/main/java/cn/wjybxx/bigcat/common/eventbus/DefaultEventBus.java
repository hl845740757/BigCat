...
import cn.wjybxx.bigcat.common.pool.DefaultObjectPool;
import cn.wjybxx.bigcat.common.pool.ObjectPool;
...
import static cn.wjybxx.bigcat.common.eventbus.EventBusUtils.postEventImp;
    ...
    public final void post(@Nonnull Object event) {
        ...
        try {
            if (event instanceof DynamicEvent eventX) {
                ...
                postEventImp(handlerMap, eventX, masterKey);
                ...
                if (childKey != null) {
                    ...
                    postEventImp(handlerMap, (Object) eventX, composeEventKey);
